...
const T = {
    en: {
        ...
        tut2_s2_text: '<strong>Left-click</strong> a cell to fill it.<br><strong>Right-click</strong> to mark it empty (✕).<br><strong>Right-click Twice</strong> to mark it with a question mark (?).<br><strong>Drag</strong> to paint multiple cells at once.<br><br>Filling a cell that should be <em>empty</em> costs you time — so think before you click!',
        ...
        ls_to_next: 'points to next code',
    ...
    de: {
        ...
        tut2_s2_text: '<strong>Linksklick</strong> füllt ein Feld.<br><strong>Rechtsklick</strong> markiert es als leer (✕).<br><strong>Rechtsclick 2x </strong> markiert es mit einem Fragezeichen (?).<br><strong>Ziehen</strong> malt mehrere Felder auf einmal.<br><br>Ein falsch gefülltes Feld kostet Zeit — also erst denken, dann klicken!',
