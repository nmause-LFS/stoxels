...
const T = {
    en: {
        ...
        tut_s4p: '<strong style="color:var(--orange)">Time Trial</strong> — 50% less time per level — 20% more Score <br><strong style="color:var(--red)">Hardcore</strong> — one mistake = instant fail — 30% more Score<br><strong style="color:var(--purple)">Ironman</strong> — items cannot be used — 15% more Score <br>Modifiers can be combined with each other.',
        ...
        mod_desc_hc: 'one wrong tile = instant fail, but 30% more Score',
